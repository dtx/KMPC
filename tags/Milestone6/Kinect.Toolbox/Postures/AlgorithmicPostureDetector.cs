...
namespace Kinect.Toolbox
{
    public class AlgorithmicPostureDetector : PostureDetector
    {
        ...
        public override void TrackPostures(Skeleton skeleton)
        {
            ...
            {
                RaisePostureDetected(KnownPostures.LeftHandOverHead.ToString());
                return;
            }
            ...
            {
                RaisePostureDetected(KnownPostures.RightHandOverHead.ToString());
                return;
            }
            ...
            {
                RaisePostureDetected(KnownPostures.LeftHello.ToString());
                return;
            }
            ...
            {
                RaisePostureDetected(KnownPostures.RightHello.ToString());
                return;
            }
        ...
        bool CheckHandsJoined(Vector3? leftHandPosition, Vector3? rightHandPosition)
        {
            ...
            {
                RaisePostureDetected(KnownPostures.HandsApart.ToString());
                return true;
            }

            RaisePostureDetected(KnownPostures.HandsJoined.ToString());
            return true;
        }      
    }
}
